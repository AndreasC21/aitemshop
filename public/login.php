    ...
    <div class="flex flex-col pt-10">
        ...
        <div class="background-item <?= $darkMode ? 'dark' : '' ?> bg-blue-100 dark:bg-gray-800 shadow-lg rounded-lg p-5 m-5 transition duration-300 ease-in-out">
            ...
            <div class="m-5 align-center justify-center ">
                <button type="submit" name="submit" class="rounded-md text-white p-2 cursor-pointer bg-blue-500 hover:bg-blue-600 w-full transition duration-300 ease-in-out">Login</button>
            </div>

            <div class="m-5 flex justify-between">
                <p class="text-sm">Belum mempunyai akun? <a href='./register.php' id="other-opt" class="<?= $darkMode ? 'dark' : '' ?> text-sm text-blue-800 dark:text-blue-200 hover:cursor-pointer text-amber transition duration-300 ease-in-out">Daftar</a></p>
            </div>
        </form>
        </div>
    </div>
